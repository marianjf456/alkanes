...
exports.ProtoStone = exports.toBuffer = void 0;
...
const toBuffer = (n) => Buffer.from((0, bytes_1.leftPadByte)(n.toString(16)), "hex");
...
class ProtoStone {
    ...
    encipher_payloads() {
        ...
        const length_payload = payloads.reduce((r, v) => r + (0, bytes_1.decipher)(v).length, 0);
        const prefix = [
            (0, exports.toBuffer)(payloads.reduce((r, v) => r || (0, bytes_1.decipher)(v)[0] === 83n, false)
                ? (0, integer_1.u128)(13)
                : (0, integer_1.u128)(this.protocolTag)),
            (0, exports.toBuffer)((0, integer_1.u128)(length_payload)),
        ];
        const result = prefix.concat(payloads.reduce((r, v) => r.concat((0, bytes_1.decipher)(v).map((v) => (0, exports.toBuffer)(v))), prefix.slice(2)));
        return result;
    }
