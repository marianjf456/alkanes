...
class ProtoruneRuneId$Type extends runtime_4.MessageType {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.height)
            exports.uint128
                .internalBinaryWrite(message.height, writer.tag(1, runtime_1.WireType.LengthDelimited).fork(), options)
                .join();
        /* protorune.uint128 txindex = 2; */
        if (message.txindex)
            exports.uint128
                .internalBinaryWrite(message.txindex, writer.tag(2, runtime_1.WireType.LengthDelimited).fork(), options)
                .join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? runtime_2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
...
class BalanceSheetItem$Type extends runtime_4.MessageType {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.balance)
            exports.uint128
                .internalBinaryWrite(message.balance, writer.tag(2, runtime_1.WireType.LengthDelimited).fork(), options)
                .join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? runtime_2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
...
class OutpointWithProtocol$Type extends runtime_4.MessageType {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.protocol)
            exports.uint128
                .internalBinaryWrite(message.protocol, writer.tag(3, runtime_1.WireType.LengthDelimited).fork(), options)
                .join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? runtime_2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
...
class ProtorunesWalletRequest$Type extends runtime_4.MessageType {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.protocolTag)
            exports.uint128
                .internalBinaryWrite(message.protocolTag, writer.tag(2, runtime_1.WireType.LengthDelimited).fork(), options)
                .join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? runtime_2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
...
class ProtoBurn$Type extends runtime_4.MessageType {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.protocolTag)
            exports.uint128
                .internalBinaryWrite(message.protocolTag, writer.tag(1, runtime_1.WireType.LengthDelimited).fork(), options)
                .join();
        /* uint32 pointer = 2; */
