...
class ProtoStone {
    ...
    encipher_payloads() {
        ...
        const prefix = [
            toBuffer(payloads.reduce((r, v) => r || (0, bytes_1.decipher)(v)[0] === 83n, false)
                ? (0, integer_1.u128)(13)
                : (0, integer_1.u128)(this.protocolTag)),
            toBuffer((0, integer_1.u128)(length_payload)),
        ];
        const result = prefix.concat(payloads.reduce((r, v) => r.concat((0, bytes_1.decipher)(v).map((v) => toBuffer(v))), prefix.slice(2)));
        return result;
    }
